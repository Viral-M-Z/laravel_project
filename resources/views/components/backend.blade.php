...
<head>
  <meta charset="utf-8" />
  <link rel="apple-touch-icon" sizes="76x76" href="<?=asset('assetsback/img/apple-icon.png')?>">
  <link rel="icon" type="image/png" href="<?=asset('assetsback/img/favicon.png')?>">
  ...
  <link href="<?=asset('assetsback/demo/demo.css')?>" rel="stylesheet" />
  <link href="<?=asset('assetsback/css/custom.css')?>" rel="stylesheet" />
  <?php $success_message = '';
        $messages = '';
        $message_array='';
...
<body class="">
  <div class="wrapper ">
    <div class="sidebar" data-color="white" data-active-color="danger">
      <div class="logo">
        <a href="<?=asset('dashboard');?>" class="simple-text logo-mini">
          <div class="logo-image-small">
            <img src="<?=asset('assetsback/img/logo-small.png')?>">
          </div>
          <!-- <p>CT</p> -->
        </a>
        <a href="<?=asset('dashboard');?>" class="simple-text logo-normal" title="Queermap
">
          Queermap
      ...
      <div class="sidebar-wrapper side-set">
        <ul class="nav">
           <li class="active ">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Queermap
</a>
          </div>
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navigation">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item btn-rotate dropdown">
                <a class="nav-link btn-rotate dropdown-toggle" href="javascript:;" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <i class="nc-icon nc-settings-gear-65"></i>
                  <p>
          ...
          <div class="row">
            ...
            <div class="credits ml-auto">
              <span class="copyright">
                ...
                </script>, made with <i class="fa fa-heart heart"></i> by 29Kreativ
              </span>
            </div>
          </div>
        </div>
  ...
  <script src="<?=asset('assetsback/custom/newcustom.js')?>"></script>
  <script>
